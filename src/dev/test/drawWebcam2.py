...
while True:
    ...
    added_image = cv2.addWeighted(background[250:350,250:350,:],alpha,foreground[0:100,0:100,:],1-alpha,0)
    # Change the region with the result
    background[250:350,250:350] = added_image
    #background[x1:x2,y1:y2]
