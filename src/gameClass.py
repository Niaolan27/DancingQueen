...
class Game:
    def __init__(self, isRunning, rectList, score, timer, music):
    ...
    def updateScore(self):
        while self.isRunning == True: # boolean variable for whether the whole program is running
